...
.setColor('RANDOM').setDescription(`${satuke}, kullanıcısına <@&${"915176017298087956"}> rolü verildi!`).setFooter(Config.Footer).setTimestamp()
message.lineReply(embed)
satuke.roles.add("915176017298087956")}
